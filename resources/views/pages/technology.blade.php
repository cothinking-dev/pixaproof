...
@section('content')
    {{-- Hero Section --}}
    <section class="relative isolate overflow-hidden bg-white px-4 pt-24 pb-20">
        {{-- Background Image --}}
        ...
        <div class="relative z-10 mx-auto max-w-4xl text-center">
            ...
            <h1 class="mt-4 text-4xl font-bold text-neutral-900 md:text-5xl lg:text-6xl">
                Security That Begins at the <span class="text-primary-600">Shutter</span>
            </h1>
            <p class="mx-auto mt-6 max-w-2xl text-lg text-neutral-600 text-pretty md:text-xl">
    ...
    <x-section id="how-it-works" pattern="hexagonal" pattern-opacity="0.03">
        <div class="text-center">
            <p class="text-sm font-medium uppercase tracking-wider text-primary-600">PIEA™ Technology</p>
            <h2 class="mt-2 text-3xl font-bold text-neutral-900 md:text-4xl">How Secure Capture Works</h2>
            <p class="mx-auto mt-4 max-w-2xl text-lg text-neutral-600 text-pretty">
        ...
        <div class="mt-16 grid gap-8 lg:grid-cols-3">
            {{-- Step 1 --}}
            <div class="relative">
                <div class="absolute -left-4 -top-4 flex h-12 w-12 items-center justify-center rounded-full bg-primary-500 text-xl font-bold text-neutral-900">
                    1
                </div>
                <x-card padding="lg" class="pt-10">
                    <div class="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-primary-500/10 text-primary-600">
                        <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M6.827 6.175A2.31 2.31 0 015.186 7.23c-.38.054-.757.112-1.134.175C2.999 7.58 2.25 8.507 2.25 9.574V18a2.25 2.25 0 002.25 2.25h15A2.25 2.25 0 0021.75 18V9.574c0-1.067-.75-1.994-1.802-2.169a47.865 47.865 0 00-1.134-.175 2.31 2.31 0 01-1.64-1.055l-.822-1.316a2.192 2.192 0 00-1.736-1.039 48.774 48.774 0 00-5.232 0 2.192 2.192 0 00-1.736 1.039l-.821 1.316z" />
                            <path stroke-linecap="round" stroke-linejoin="round" d="M16.5 12.75a4.5 4.5 0 11-9 0 4.5 4.5 0 019 0zM18.75 10.5h.008v.008h-.008V10.5z" />
                        </svg>
                    </div>
                    <h3 class="text-xl font-semibold text-neutral-900">Live Capture Authentication</h3>
                    <ul class="mt-4 space-y-2 text-neutral-600">
                        <li class="flex items-start gap-2">
                            <svg class="mt-1 h-4 w-4 shrink-0 text-primary-600" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
            ...
            <div class="relative">
                ...
                <x-card padding="lg" class="pt-10">
                    ...
                    <h3 class="text-xl font-semibold text-neutral-900">Cryptographic Signature Generation</h3>
                    <ul class="mt-4 space-y-2 text-neutral-600">
                        <li class="flex items-start gap-2">
                            <svg class="mt-1 h-4 w-4 shrink-0 text-primary-600" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
            ...
            <div class="relative">
                ...
                <x-card padding="lg" class="pt-10">
                    ...
                    <h3 class="text-xl font-semibold text-neutral-900">Invisible Encoding</h3>
                    <ul class="mt-4 space-y-2 text-neutral-600">
                        <li class="flex items-start gap-2">
                            <svg class="mt-1 h-4 w-4 shrink-0 text-primary-600" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
        ...
        <div class="mx-auto mt-12 max-w-2xl text-center">
            <p class="text-lg text-neutral-600">
                <span class="font-semibold text-neutral-900">Result:</span> Photo can be stored, shared, or uploaded normally -
    ...
    <x-section bg="surface">
        <div class="grid items-center gap-12 lg:grid-cols-2">
            <div>
                <p class="text-sm font-medium uppercase tracking-wider text-primary-600">End-to-End Protection</p>
                <h2 class="mt-2 text-3xl font-bold text-neutral-900 md:text-4xl">Secure Transmission Pipeline</h2>
                <p class="mt-4 text-lg text-neutral-600 text-pretty">
                    From the moment of capture to verification, your images are protected by enterprise-grade security.
                </p>

                <div class="mt-8 space-y-4">
                    <div class="flex items-center gap-4 rounded-lg border border-neutral-200 bg-white p-4">
                        ...
                        <div>
                            <h4 class="font-semibold text-neutral-900">Encrypted Upload</h4>
                            <p class="text-sm text-neutral-500">TLS 1.3 encryption for all data in transit</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-4 rounded-lg border border-neutral-200 bg-white p-4">
                        ...
                        <div>
                            <h4 class="font-semibold text-neutral-900">MITM Prevention</h4>
                            <p class="text-sm text-neutral-500">Certificate pinning prevents interception</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-4 rounded-lg border border-neutral-200 bg-white p-4">
                        ...
                        <div>
                            <h4 class="font-semibold text-neutral-900">Integrity Verification</h4>
                            <p class="text-sm text-neutral-500">Signature validated during transmission</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-4 rounded-lg border border-neutral-200 bg-white p-4">
                        ...
                        <div>
                            <h4 class="font-semibold text-neutral-900">Secure Storage</h4>
                            <p class="text-sm text-neutral-500">Protected at rest in ISO 27001 infrastructure</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="flex justify-center">
                <div class="relative w-full max-w-md">
                    ...
                    <div class="rounded-2xl border border-neutral-200 bg-white p-8 shadow-lg shadow-black/20">
                        <div class="flex flex-col items-center gap-4">
                            {{-- SDK --}}
                            <div class="flex w-full items-center justify-between rounded-lg bg-white/50 p-4">
                                <span class="font-medium text-neutral-900">SDK Capture</span>
                            ...
                            {{-- Encryption --}}
                            <div class="flex w-full items-center justify-between rounded-lg bg-white/50 p-4">
                                <span class="font-medium text-neutral-900">TLS 1.3 Encrypted</span>
                            ...
                            {{-- Cloud --}}
                            <div class="flex w-full items-center justify-between rounded-lg bg-white/50 p-4">
                                <span class="font-medium text-neutral-900">PixaProof Cloud</span>
                                <span class="rounded-full bg-primary-500/10 px-2 py-1 text-xs font-medium text-primary-600">ISO 27001</span>
                            </div>
                            {{-- Arrow --}}
                            <svg class="h-6 w-6 text-primary-600" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 13.5L12 21m0 0l-7.5-7.5M12 21V3" />
                            ...
                            <div class="flex w-full items-center justify-between rounded-lg bg-green-500/10 p-4">
                                <span class="font-medium text-neutral-900">Verification Result</span>
    ...
    <x-section pattern="circuit" pattern-opacity="0.03">
        <div class="text-center">
            <p class="text-sm font-medium uppercase tracking-wider text-primary-600">Detection Capabilities</p>
            <h2 class="mt-2 text-3xl font-bold text-neutral-900 md:text-4xl">35+ Tamper Detection Tests</h2>
            <p class="mx-auto mt-4 max-w-2xl text-lg text-neutral-600 text-pretty">
        ...
        <div class="mt-12 grid gap-6 md:grid-cols-2">
            ...
            <x-card padding="lg">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h3 class="text-xl font-semibold text-neutral-900">Capture Authenticity</h3>
                        <p class="text-sm text-neutral-500">7 tests</p>
                    </div>
                </div>
                <ul class="mt-6 grid grid-cols-2 gap-2 text-sm text-neutral-600">
            ...
            <x-card padding="lg">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h3 class="text-xl font-semibold text-neutral-900">Image Integrity</h3>
                        <p class="text-sm text-neutral-500">12 tests</p>
                    </div>
                </div>
                <ul class="mt-6 grid grid-cols-2 gap-2 text-sm text-neutral-600">
                    <li class="flex items-center gap-2">
            ...
            <x-card padding="lg">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h3 class="text-xl font-semibold text-neutral-900">AI & Synthetic Media</h3>
                        <p class="text-sm text-neutral-500">8 tests</p>
                    </div>
                </div>
                <ul class="mt-6 grid grid-cols-2 gap-2 text-sm text-neutral-600">
                    <li class="flex items-center gap-2">
            ...
            <x-card padding="lg">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h3 class="text-xl font-semibold text-neutral-900">Metadata & Context</h3>
                        <p class="text-sm text-neutral-500">8 tests</p>
                    </div>
                </div>
                <ul class="mt-6 grid grid-cols-2 gap-2 text-sm text-neutral-600">
    ...
    <x-section bg="surface">
        <div class="text-center">
            <p class="text-sm font-medium uppercase tracking-wider text-primary-600">SDK Features</p>
            <h2 class="mt-2 text-3xl font-bold text-neutral-900 md:text-4xl">SDK Capabilities</h2>
            <p class="mx-auto mt-4 max-w-2xl text-lg text-neutral-600 text-pretty">
        ...
        <div class="mt-12 grid gap-8 lg:grid-cols-2">
            {{-- Platforms --}}
            <div>
                <h3 class="text-lg font-semibold text-neutral-900">Platforms Supported</h3>
                <div class="mt-4 flex flex-wrap gap-3">
                    <span class="inline-flex items-center gap-2 rounded-lg bg-white/50 px-4 py-2 text-sm font-medium text-neutral-600">
                    ...
                    <span class="inline-flex items-center gap-2 rounded-lg bg-neutral-100 px-4 py-2 text-sm font-medium text-neutral-500">
            ...
            {{-- Features --}}
            <div>
                <h3 class="text-lg font-semibold text-neutral-900">Core Features</h3>
        ...
        {{-- Security Measures --}}
        <div class="mt-12">
            <h3 class="text-center text-lg font-semibold text-neutral-900">Built-in Security Measures</h3>
            <div class="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                <div class="flex items-center gap-3 rounded-lg border border-red-500/30 bg-red-500/10 p-4">
                    ...
                    <span class="text-sm font-medium text-neutral-600">Gallery access blocked</span>
                </div>
                <div class="flex items-center gap-3 rounded-lg border border-red-500/30 bg-red-500/10 p-4">
                    <svg class="h-6 w-6 text-red-500" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636" />
                    </svg>
                    <span class="text-sm font-medium text-neutral-600">Screenshot detection</span>
                </div>
                <div class="flex items-center gap-3 rounded-lg border border-red-500/30 bg-red-500/10 p-4">
                    <svg class="h-6 w-6 text-red-500" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636" />
                    </svg>
                    <span class="text-sm font-medium text-neutral-600">Emulator/VM blocked</span>
                </div>
                <div class="flex items-center gap-3 rounded-lg border border-red-500/30 bg-red-500/10 p-4">
                    <svg class="h-6 w-6 text-red-500" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636" />
                    </svg>
                    <span class="text-sm font-medium text-neutral-600">Replay attacks prevented</span>
                </div>
            </div>
        </div>
    </x-section>
    ...
    <x-section>
        <div class="text-center">
            <p class="text-sm font-medium uppercase tracking-wider text-primary-600">Performance</p>
            <h2 class="mt-2 text-3xl font-bold text-neutral-900 md:text-4xl">Enterprise-Grade Performance</h2>
        </div>
    ...
    <x-section bg="dark">
        <div class="text-center">
            ...
            <p class="mx-auto mt-4 max-w-2xl text-lg text-neutral-300 text-pretty">
                Talk to our technical team to learn how PIEA™ technology can protect your verification workflows.
            </p>
            <div class="mt-8 flex flex-wrap justify-center gap-4">
                <x-button href="{{ route('contact') }}" size="lg">Talk to Technical Team</x-button>
                <x-button href="#" variant="outline" size="lg" class="border-white text-white hover:bg-white/10">View Developer Docs</x-button>
            </div>
        </div>
    </x-section>
@endsection
