...
@section('content')
    ...
    <section class="relative isolate overflow-hidden bg-white px-4 pt-32 pb-20 lg:pt-40 lg:pb-28">
        ...
        <div class="relative z-10 max-w-4xl mx-auto text-center">
            <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary-500/20 border border-primary-400/30 mb-6">
                <x-heroicon-s-shield-check class="w-4 h-4 text-primary-300" />
                <span class="text-sm font-medium text-primary-200 uppercase tracking-wider">Insurance Solutions</span>
            </div>
            ...
            <div class="inline-flex items-center gap-3 px-6 py-3 rounded-xl bg-white/80 border border-neutral-200">
                <span class="text-3xl font-bold text-neutral-900">40-60%</span>
                <span class="text-neutral-600 text-left text-sm">reduction in fraudulent claims<br>for insurers using PixaProof</span>
            </div>
    ...
    <x-section>
        <div class="text-center mb-16">
            <p class="text-primary-600 font-semibold uppercase tracking-wider text-sm mb-4">The Crisis</p>
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto mb-16">
            ...
            @foreach ($stats as $stat)
                <div class="text-center p-6 rounded-xl bg-white border border-neutral-200 shadow-lg shadow-black/20">
                    <div class="text-2xl lg:text-3xl font-bold text-primary-600 mb-2">{{ $stat['value'] }}</div>
        ...
        <div class="max-w-5xl mx-auto">
            <h3 class="text-xl font-semibold text-neutral-900 text-center mb-8">Common Fraud Types</h3>
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                @foreach ($problems as $problem)
                    <div class="flex items-start gap-4 p-4 rounded-xl bg-white border border-neutral-200 shadow-lg shadow-black/20">
                        <div class="flex-shrink-0 w-10 h-10 rounded-lg bg-primary-500/10 flex items-center justify-center">
                            <x-dynamic-component :component="'heroicon-s-' . $problem['icon']" class="w-5 h-5 text-primary-600" />
                        </div>
                        <div>
                            <h4 class="font-medium text-neutral-900 mb-1">{{ $problem['title'] }}</h4>
                            <p class="text-sm text-neutral-600">{{ $problem['desc'] }}</p>
                        </div>
                    </div>
                @endforeach
            </div>
                ...
                <div class="space-y-6">
                    ...
                    @foreach ($steps as $index => $step)
                        <div class="relative flex items-start gap-6">
                            <div class="relative z-10 flex-shrink-0 w-12 h-12 rounded-full bg-primary-500 flex items-center justify-center text-neutral-900 font-bold">
                                {{ $index + 1 }}
                            </div>
    ...
    <x-section>
        ...
        <div class="max-w-5xl mx-auto overflow-hidden rounded-2xl border border-neutral-200 bg-white">
            <table class="w-full">
                <thead class="bg-white/50">
                    <tr>
                        <th class="px-6 py-4 text-left text-sm font-semibold text-neutral-900">Category</th>
                        <th class="px-6 py-4 text-left text-sm font-semibold text-neutral-900">Features</th>
                    </tr>
                </thead>
    ...
    <x-section bg="surface">
        <div class="text-center mb-16">
            <p class="text-primary-600 font-semibold uppercase tracking-wider text-sm mb-4">Detection</p>
            <h2 class="text-3xl md:text-4xl font-bold text-neutral-900 mb-6">
        ...
        <div class="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            @foreach ($detection as $category)
                <div class="p-6 rounded-2xl bg-white border border-neutral-200 shadow-lg shadow-black/20">
                    <h3 class="text-lg font-semibold text-neutral-900 mb-4">{{ $category['title'] }}</h3>
                    <ul class="space-y-3">
    ...
    <x-section>
        <div class="text-center mb-16">
            <p class="text-primary-600 font-semibold uppercase tracking-wider text-sm mb-4">Speed</p>
            <h2 class="text-3xl md:text-4xl font-bold text-neutral-900 mb-6">
                From weeks to hours
            </h2>
        </div>
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="grid md:grid-cols-2 gap-8 mb-12">
                ...
                <div class="p-6 rounded-2xl bg-white border border-neutral-200 shadow-lg shadow-black/20">
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <h3 class="text-lg font-semibold text-neutral-900">Traditional: 2-3 Weeks</h3>
                    </div>
                ...
                {{-- With PixaProof --}}
                <div class="p-6 rounded-2xl bg-primary-50 border border-primary-200">
                    <div class="flex items-center gap-3 mb-6">
                        <x-heroicon-s-check-circle class="w-6 h-6 text-primary-600" />
                        <h3 class="text-lg font-semibold text-neutral-900">With PixaProof: Same Day</h3>
                    </div>
                    <div class="space-y-4 text-sm">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                @foreach ($benefits as $benefit)
                    <div class="text-center p-4 rounded-xl bg-white border border-neutral-200 shadow-lg shadow-black/20">
                        <div class="text-2xl font-bold text-primary-600 mb-1">{{ $benefit['value'] }}</div>
                        <div class="text-xs text-neutral-600">{{ $benefit['label'] }}</div>
                    </div>
                @endforeach
            </div>
        </div>
    ...
    <x-section bg="surface">
        <div class="max-w-5xl mx-auto">
            ...
            <div class="grid lg:grid-cols-2 gap-8 items-start">
                {{-- Profile --}}
                <div class="p-8 rounded-2xl bg-white border border-neutral-200 shadow-lg shadow-black/20">
                    <h3 class="text-xl font-bold text-neutral-900 mb-6">Carrier Profile</h3>
                    <div class="space-y-4">
                        <div class="flex justify-between py-3 border-b border-neutral-200">
                            <span class="text-neutral-600">Policies</span>
                            <span class="text-neutral-900 font-medium">2M+ auto policies</span>
                        </div>
                        <div class="flex justify-between py-3 border-b border-neutral-200">
                            <span class="text-neutral-600">Annual Claims</span>
                            <span class="text-neutral-900 font-medium">$500M+</span>
                        </div>
                        <div class="flex justify-between py-3">
                            <span class="text-neutral-600">Previous Fraud Rate</span>
                ...
                {{-- Results --}}
                <div class="p-8 rounded-2xl bg-white border border-neutral-200 shadow-lg shadow-black/20">
                    <h3 class="text-xl font-bold text-neutral-900 mb-6">Results After 6 Months</h3>
                    <div class="grid grid-cols-2 gap-4">
                        <div class="p-4 rounded-xl bg-white">
                            <div class="text-2xl font-bold text-primary-600">62%</div>
                            <div class="text-sm text-neutral-700">Fraud reduction</div>
                            <div class="text-xs text-neutral-500">18% → 6.8%</div>
                        </div>
                        <div class="p-4 rounded-xl bg-white">
                            <div class="text-2xl font-bold text-primary-600">$12M</div>
                            <div class="text-sm text-neutral-700">Prevented payouts</div>
                        </div>
                        <div class="p-4 rounded-xl bg-white">
                            <div class="text-2xl font-bold text-primary-600">9 days</div>
                            <div class="text-sm text-neutral-700">Faster settlement</div>
                            <div class="text-xs text-neutral-500">14 → 5 days</div>
                        </div>
                        <div class="p-4 rounded-xl bg-white">
                            <div class="text-2xl font-bold text-primary-600">45%</div>
                            <div class="text-sm text-neutral-700">Fewer site visits</div>
                        </div>
                        <div class="p-4 rounded-xl bg-white">
                            <div class="text-2xl font-bold text-primary-600">28%</div>
                            <div class="text-sm text-neutral-700">Better CSAT</div>
                        </div>
                        <div class="p-4 rounded-xl bg-white">
                            <div class="text-2xl font-bold text-primary-600">$3.2M</div>
                            <div class="text-sm text-neutral-700">Op. savings</div>
                        </div>
                    </div>
                </div>
            </div>
