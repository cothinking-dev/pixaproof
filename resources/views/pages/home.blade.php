...
@section('content')
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl md:text-6xl dark:text-white">
                    Verify Photo
                    <span class="text-brand-600">Authenticity</span>
                </h1>
                ...
                <div class="mt-10 flex flex-wrap justify-center gap-4">
                    <a href="#" class="inline-flex items-center rounded-lg bg-brand-600 px-6 py-3 text-base font-medium text-white shadow-sm transition hover:bg-brand-700">
                        Coming Soon to App Store
                    </a>
                    <a href="#" class="inline-flex items-center rounded-lg border border-gray-300 bg-white px-6 py-3 text-base font-medium text-gray-700 shadow-sm transition hover:bg-gray-50 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700">
    ...
    <section id="features" class="py-20">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                <h2 class="text-3xl font-bold text-gray-900 dark:text-white">Why PixaProof?</h2>
            ...
            <div class="mt-16 grid gap-8 md:grid-cols-3">
                ...
                <div class="rounded-xl bg-gray-50 p-8 dark:bg-gray-800">
                    <div class="flex h-12 w-12 items-center justify-center rounded-lg bg-brand-600 text-white">
                        <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285z" />
                        </svg>
                    </div>
                    <h3 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">AI Detection</h3>
                ...
                <div class="rounded-xl bg-gray-50 p-8 dark:bg-gray-800">
                    ...
                    <h3 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Instant Results</h3>
                    <p class="mt-2 text-gray-600 dark:text-gray-300">
                ...
                <div class="rounded-xl bg-gray-50 p-8 dark:bg-gray-800">
                    ...
                    <h3 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Privacy First</h3>
                    <p class="mt-2 text-gray-600 dark:text-gray-300">
