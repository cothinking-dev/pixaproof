...
@section('content')
    <section class="py-20">
        <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
            <h1 class="text-4xl font-bold text-white">About PixaProof</h1>
            ...
            <div class="prose prose-lg prose-invert mt-8">
                ...
                <h2 class="mt-8 text-2xl font-semibold text-white">Our Mission</h2>
                <p class="text-gray-300">
                ...
                <h2 class="mt-8 text-2xl font-semibold text-white">How It Works</h2>
                <p class="text-gray-300">
                ...
                <h2 class="mt-8 text-2xl font-semibold text-white">Privacy Commitment</h2>
                <p class="text-gray-300">
            ...
            <div class="mt-12">
                <a href="{{ route('contact') }}" class="inline-flex items-center rounded-lg bg-brand-500 px-6 py-3 text-base font-medium text-white shadow-sm transition hover:bg-brand-600">
                    Contact Us
                </a>
            </div>
        </div>
