...
@section('content')
    <section class="py-20">
        <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
            ...
            <p class="mt-4 text-sm text-gray-500 dark:text-gray-400">Last updated: {{ date('F j, Y') }}</p>

            <div class="prose prose-lg mt-8 dark:prose-invert">
                <h2 class="text-2xl font-semibold text-gray-900 dark:text-white">Introduction</h2>
                ...
                <h2 class="mt-8 text-2xl font-semibold text-gray-900 dark:text-white">Information We Collect</h2>
                <p class="text-gray-600 dark:text-gray-300">
                ...
                <h2 class="mt-8 text-2xl font-semibold text-gray-900 dark:text-white">How We Use Your Information</h2>
                <p class="text-gray-600 dark:text-gray-300">
                ...
                <h2 class="mt-8 text-2xl font-semibold text-gray-900 dark:text-white">Data Security</h2>
                <p class="text-gray-600 dark:text-gray-300">
                ...
                <h2 class="mt-8 text-2xl font-semibold text-gray-900 dark:text-white">Contact Us</h2>
                <p class="text-gray-600 dark:text-gray-300">
                    If you have questions about this Privacy Policy, please <a href="{{ route('contact') }}" class="text-brand-600 hover:text-brand-700 dark:text-brand-400">contact us</a>.
                </p>
            </div>
        </div>
    </section>
