...
>
    ...
    <div class="max-w-5xl mx-auto hidden lg:grid lg:grid-cols-5 lg:gap-12">
        ...
        <div class="sticky top-24 col-span-3">
            <div class="overflow-hidden rounded-2xl border border-surface-700 bg-surface-800">
                {{-- Image --}}
                <div class="aspect-video overflow-hidden bg-surface-900">
                    <img
                        x-ref="image"
                    ...
                    <div class="hidden h-full w-full items-center justify-center bg-gradient-to-br from-surface-800 to-surface-900">
                        <div class="text-center">
                            <svg class="mx-auto h-16 w-16 text-surface-600" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m-1.5-1.5l1.409-1.409a2.25 2.25 0 013.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 001.5-1.5V6a1.5 1.5 0 00-1.5-1.5H3.75A1.5 1.5 0 002.25 6v12a1.5 1.5 0 001.5 1.5zm10.5-11.25h.008v.008h-.008V8.25zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />
                            </svg>
                            <p class="mt-2 text-sm text-surface-500">Image coming soon</p>
                        </div>
                    </div>
                </div>
                ...
                <div x-ref="content" class="p-6">
                    {{-- Icon --}}
                    <div class="mb-3 flex h-10 w-10 items-center justify-center rounded-lg bg-brand-500/10">
                    ...
                    <h4 class="text-lg font-semibold text-white" x-text="tabs[activeTab]?.title"></h4>
                    <p class="mt-2 text-gray-400" x-text="tabs[activeTab]?.description"></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:hidden">
        <template x-for="(tab, index) in tabs" :key="'mobile-' + index">
            <div class="rounded-xl border border-surface-700 bg-surface-800 p-5">
                ...
                <h3 class="text-lg font-semibold text-white" x-text="tab.title"></h3>
                <p class="mt-2 text-sm text-gray-400" x-text="tab.description"></p>
            </div>
        </template>
    </div>
</div>
