    ...
    <div class="grid gap-8 md:grid-cols-2">
        ...
        <div class="relative">
            ...
            <div class="flex justify-center">
                <div class="relative">
                    <x-graphics.phone-mockup size="lg">
                        <div class="flex h-full flex-col">
                            {{-- Status bar --}}
                            <div class="flex items-center justify-between px-3 py-2 text-[10px] text-gray-400">
                                <span>9:41</span>
                                <span class="text-[8px]">Gallery</span>
                            </div>
                            ...
                            <div class="flex-1 px-2 pb-2">
                                        ...
                                        <div class="aspect-square rounded bg-white {{ $i === 2 ? 'ring-1 ring-primary-500' : '' }}">
                                            @if($i === 2)
                                                ...
                                                <div class="flex h-full items-center justify-center">
                                                    <svg class="h-3 w-3 text-gray-500" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                ...
                                {{-- Warning badge --}}
                                <div class="mt-2 rounded border border-yellow-500/30 bg-yellow-500/10 p-1.5">
                                    <div class="flex items-center gap-1">
                                        <svg class="h-2.5 w-2.5 text-yellow-500" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z" />
                                        </svg>
                                        <span class="text-[7px] text-yellow-400">Pre-edited photo</span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="mt-4 flex justify-center">
                        <div class="flex items-center gap-2 rounded-full bg-red-500/20 px-3 py-1.5 text-xs text-red-400">
        ...
        <div class="relative">
            ...
            <div class="flex justify-center">
                <div class="relative">
                        ...
                        <div class="flex h-full flex-col">
                            ...
                            <div class="flex items-center justify-between px-3 py-2 text-[10px] text-gray-400">
                                ...
                                <div class="flex items-center gap-1">
                                    ...
                                    <span class="text-[8px] text-green-400">Secured</span>
                                </div>
                            </div>

                            {{-- Blocked overlay --}}
                            <div class="flex flex-1 flex-col items-center justify-center p-3">
                                <div class="mb-2 flex h-10 w-10 items-center justify-center rounded-full bg-red-500/20">
                                ...
                                <p class="text-center text-[10px] font-semibold text-white">Gallery Blocked</p>
                                <p class="mt-1 text-center text-[8px] text-gray-400">Live camera only</p>

                                {{-- Action button --}}
                                <button class="mt-3 rounded bg-green-500 px-3 py-1 text-[8px] font-medium text-white">
                                    Use Camera
                                </button>
                            </div>
                    ...
                    {{-- Result indicator --}}
                    <div class="mt-4 flex justify-center">
                        <div class="flex items-center gap-2 rounded-full bg-green-500/20 px-3 py-1.5 text-xs text-green-400">
                            <svg class="h-3 w-3" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
